...
namespace PractosNumber5
{
    ...
    {
        static string[] forma = new string[5] { "  Круглый - 100;", "  Квадратный- 200;", "  Треугольный - 300;", "  Ромб - 400;", "  Звезда- 500;" };
        static string[] size = new string[5] { "  Маленький - 300;", "  Средний - 450;", "  Большой- 600;", "  Подарочный - 900;", "  Свадебный - 1200;" };
        static string[] vkus = new string[5] { "  Клубничный - 300;", "  Малиновый - 400;", "  Шоколадный - 200;", "  Ореховый - 600;", "  Апельсиновый - 500;" };
                            ...
                            case ConsoleKey.Enter:
                                switch (position)
                                {
                                    ...
                                    case 9:
                                        ...
                                        File.AppendAllText("\"C:\\Users\\Эльмар\\Desktop\\История заказов.txt\"", $"Время заказа {date}\r\n Цена: {x}\r\n Состав заказа: {y}\r\n");
                                        x = 0;
                                        y = "";
                                        SubClass.x = 0;
                                        SubClass.y = "";
